...
#![feature(associated_consts, fn_traits, get_type_id, pub_restricted, unsize)]
#![feature(alloc, box_syntax, conservative_impl_trait, fundamental, unboxed_closures)]
#![feature(libc, untagged_unions)]
...
pub use self::frameworks::native;
...
pub mod prelude {
    ...
    pub use frameworks::native::Native;
    pub use frameworks::opencl::OpenCL;
