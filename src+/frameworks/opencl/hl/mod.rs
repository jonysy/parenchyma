...
impl Buffer {
    ...
    pub fn retain(&self) -> Result {
        unsafe {
            let ret_value = cl::clRetainMemObject(self.0);
    ...
    pub fn release(&self) -> Result {
        unsafe {
            let ret_value = cl::clReleaseMemObject(self.0);
...
impl Context {
    ...
    pub fn new(devices: &[Device]) -> Result<Self> {
        unsafe {
            ...
            let cl_context = cl::clCreateContext(
                properties, 
                number_of_devices, 
                raw_devices_ptr, 
                pfn_notify, 
    ...
    pub fn create_program_with_source<I>(&self, strings: &[I]) -> Result<Program> 
        ...
        unsafe {
            ...
            let cl_program = cl::clCreateProgramWithSource(self.0, n, ptr, lens_ptr, &mut errcode);

            let ret_value = cl::CLStatus::new(errcode).expect("failed to convert i32 to CLStatus");
    ...
    fn retain(&self) -> Result {
        unsafe {
            let ret_value = cl::clRetainContext(self.0);
            return utility::check(ret_value, || {});
        }
    }
    ...
    fn release(&self) -> Result {
        unsafe {
            let ret_value = cl::clReleaseContext(self.0);
            return utility::check(ret_value, || {});
        }
    }
}
...
#[derive(Clone, Debug)]
pub struct Device(cl::cl_device_id);
...
impl Device {
    ...
    pub fn address_bits(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_ADDRESS_BITS;
    ...
    pub fn available(&self) -> Result<bool> {
        let parameter = cl::CL_DEVICE_AVAILABLE;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res != 0)
    }
    ...
    pub fn compiler_available(&self) -> Result<bool> {
        let parameter = cl::CL_DEVICE_COMPILER_AVAILABLE;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res != 0)
    }
...
//    }
    ...
    pub fn endian_little(&self) -> Result<bool> {
        let parameter = cl::CL_DEVICE_ENDIAN_LITTLE;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res != 0)
    }
    ...
    pub fn error_correction_support(&self) -> Result<bool> {
        let parameter = cl::CL_DEVICE_ERROR_CORRECTION_SUPPORT;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res != 0)
    }
...
//    }
    ...
    pub fn extensions(&self) -> Result<Vec<String>> {
        let parameter = cl::CL_DEVICE_EXTENSIONS;
    ...
    pub fn global_mem_cache_size(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_GLOBAL_MEM_CACHE_SIZE;
...
//    }
    ...
    pub fn global_mem_cacheline_size(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn global_mem_size(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_GLOBAL_MEM_SIZE;
        let res = self.info(parameter, |_| 0u64, |b| b as *mut u64 as _)?;
        Ok(res)
    }
...
//    }
    ...
    pub fn image_support(&self) -> Result<bool> {
        let parameter = cl::CL_DEVICE_IMAGE_SUPPORT;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res != 0)
    }
    ...
    pub fn image2d_max_height(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_IMAGE2D_MAX_HEIGHT;
    ...
    pub fn image2d_max_width(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_IMAGE2D_MAX_WIDTH;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn image3d_max_depth(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_IMAGE3D_MAX_DEPTH;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn image3d_max_height(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_IMAGE3D_MAX_HEIGHT;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn image3d_max_width(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_IMAGE3D_MAX_WIDTH;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn local_mem_size(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_LOCAL_MEM_SIZE;
        let res = self.info(parameter, |_| 0u64, |b| b as *mut u64 as _)?;
        Ok(res)
    }
...
//    }
    ...
    pub fn max_clock_frequency(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_CLOCK_FREQUENCY;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_compute_units(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_COMPUTE_UNITS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_constant_args(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_CONSTANT_ARGS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_constant_buffer_size(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE;
        let res = self.info(parameter, |_| 0u64, |b| b as *mut u64 as _)?;
        Ok(res)
    }
    ...
    pub fn max_mem_alloc_size(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_MAX_MEM_ALLOC_SIZE;
        let res = self.info(parameter, |_| 0u64, |b| b as *mut u64 as _)?;
        Ok(res)
    }
    ...
    pub fn max_parameter_size(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_MAX_PARAMETER_SIZE;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn max_read_image_args(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_READ_IMAGE_ARGS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_samplers(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_SAMPLERS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_work_group_size(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_MAX_WORK_GROUP_SIZE;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
    ...
    pub fn max_work_item_dimensions(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn max_work_item_sizes(&self) -> Result<Vec<usize>> {
        let parameter = cl::CL_DEVICE_MAX_WORK_ITEM_SIZES;
    ...
    pub fn max_write_image_args(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MAX_WRITE_IMAGE_ARGS;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn mem_base_addr_align(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MEM_BASE_ADDR_ALIGN;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn min_data_type_align_size(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn name(&self) -> Result<String> {
        let parameter = cl::CL_DEVICE_NAME;
        let res = self.info(parameter, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR;
//        
//        unimplemented!()
//    }
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT;
//        
//        unimplemented!()
//    }
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT;
//        
//        unimplemented!()
//    }
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG;
//        
//        unimplemented!()
//    }
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT;
//        
//        unimplemented!()
//    }
...
//
//        let _ = cl::CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE;
//        
//        unimplemented!()
//    }
    ...
    pub fn profile(&self) -> Result<String> {
        let parameter = cl::CL_DEVICE_PROFILE;
        let res = self.info(parameter, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
        res.map(|b| String::from_utf8(b).unwrap())
    }
    ...
    pub fn profiling_timer_resolution(&self) -> Result<usize> {
        let parameter = cl::CL_DEVICE_PROFILING_TIMER_RESOLUTION;
        let res = self.info(parameter, |_| 0usize, |b| b as *mut usize as _)?;
        Ok(res)
    }
...
//    }
    ...
    pub fn type_(&self) -> Result<u64> {
        let parameter = cl::CL_DEVICE_TYPE;
        let res = self.info(parameter, |_| 0u64, |b| b as *mut u64 as _)?;
        Ok(res)
    }
    ...
    pub fn vendor(&self) -> Result<String> {
        let parameter = cl::CL_DEVICE_VENDOR;
        let res = self.info(parameter, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
        res.map(|b| String::from_utf8(b).unwrap())
    }
    ...
    pub fn vendor_id(&self) -> Result<u32> {
        let parameter = cl::CL_DEVICE_VENDOR_ID;
        let res = self.info(parameter, |_| 0u32, |b| b as *mut u32 as _)?;
        Ok(res)
    }
    ...
    pub fn version(&self) -> Result<String> {
        let parameter = cl::CL_DEVICE_VERSION;
        let res = self.info(parameter, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
        res.map(|b| String::from_utf8(b).unwrap())
    }
    ...
    pub fn driver_version(&self) -> Result<String> {
        let parameter = cl::CL_DRIVER_VERSION;
        let res = self.info(parameter, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
        res.map(|b| String::from_utf8(b).unwrap())
    }
    ...
    fn info_size(&self, parameter: u32) -> Result<usize> {
        unsafe {
            let mut size = 0;
            let ret_value = cl::clGetDeviceInfo(self.0, parameter, 0, ptr::null_mut(), &mut size);
    ...
    fn info<F1, F2, T>(&self, p: u32, f1: F1, f2: F2) -> Result<T>
        ...
        unsafe {
            ...
            let ret_value = cl::clGetDeviceInfo(self.0, p, size, f2(&mut ret), ptr::null_mut());
...
impl Kernel {
    ...
    fn retain(&self) -> Result {
        unsafe {
            let ret_value = cl::clRetainKernel(self.0);
            return utility::check(ret_value, || {});
        }
    }
    ...
    fn release(&self) -> Result {
        unsafe {
            let ret_value = cl::clReleaseKernel(self.0);
            return utility::check(ret_value, || {});
        }
    }
}
...
#[derive(Clone, Debug)]
pub struct Platform(cl::cl_platform_id);
...
impl Platform {
    ...
    pub fn profile(&self) -> Result<String> {
        self.info(cl::CL_PLATFORM_PROFILE)
    }

    /// Returns the platform name.
    pub fn name(&self) -> Result<String> {
        self.info(cl::CL_PLATFORM_NAME)
    }

    /// Returns the platform vendor.
    pub fn vendor(&self) -> Result<String> {
        self.info(cl::CL_PLATFORM_VENDOR)
    }
    ...
    pub fn extensions(&self) -> Result<Vec<String>> {
        ...
        self.info(cl::CL_PLATFORM_EXTENSIONS).map(closure)
    }

    pub fn ndevices_by_type(&self, t: u64) -> Result<u32> {
        unsafe {
            let mut ndevices = 0;
            let ret_value = cl::clGetDeviceIDs(self.0, t, 0, ptr::null_mut(), &mut ndevices);
    ...
    pub fn devices_by_type(&self, t: u64) -> Result<Vec<Device>> {
        unsafe {
            ...
            let mut vec_id = vec![0 as cl::cl_device_id; ndevices as usize];
            let n = ptr::null_mut();

            let ret_value = cl::clGetDeviceIDs(self.0, t, ndevices, vec_id.as_mut_ptr(), n);
    ...
    fn info_size(&self, parameter: u32) -> Result<usize> {
        unsafe {
            let mut size = 0;
            let ret_value = cl::clGetPlatformInfo(self.0, parameter, 0, ptr::null_mut(), &mut size);
    ...
    fn info(&self, parameter: u32) -> Result<String> {
        unsafe {
            ...
            let ret_value = cl::clGetPlatformInfo(
                self.0, 
                parameter, 
                size, 
...
impl Program {
    ...
    pub fn build<T>(&self, devices: &[Device], opt: T) -> Result where T: Into<Option<String>> {
        unsafe {
            ...
            let raw_devices: Vec<cl::cl_device_id> = devices.iter().map(|d| d.0).collect();
            let raw_devices_ptr = raw_devices.as_ptr();
            ...
            let ret_value = cl::clBuildProgram(
                self.0, 
                num_devices, 
                raw_devices_ptr,
                options, 
    ...
    pub fn create_kernel<T>(&self, name: T) -> Result<Kernel> where T: AsRef<str> {
        unsafe {
            ...
            let cl_kernel = cl::clCreateKernel(self.0, ptr, &mut errcode);
            let ret_value = cl::CLStatus::new(errcode).expect("failed to convert i32 to CLStatus");
    ...
    fn retain(&self) -> Result {
        unsafe {
            let ret_value = cl::clRetainProgram(self.0);
            return utility::check(ret_value, || {});
        }
    }
    ...
    fn release(&self) -> Result {
        unsafe {
            let ret_value = cl::clReleaseProgram(self.0);
            return utility::check(ret_value, || {});
        }
    }
}
...
#[derive(Debug)]
pub struct Queue(cl::cl_command_queue);
...
impl Queue {
    ...
    pub fn new(context: &Context, device: &Device, properties: u64) -> Result<Self> {
        unsafe {
            let mut errcode_ret: i32 = 0;
            let cl_command_queue = cl::clCreateCommandQueue(context.0, device.0, 
                properties, &mut errcode_ret);
            let ret_value = cl::CLStatus::new(errcode_ret).expect("failed to convert i32 to CLStatus");
    ...
    pub fn enqueue_write_buffer(
        ...
        unsafe {
            ...
            let ret_value = cl::clEnqueueWriteBuffer(
                self.0, 
                buffer.0, 
                blocking_write_u32,
                offset,
    ...
    pub fn enqueue_read_buffer(
        ...
        unsafe {
            ...
            let ret_value = cl::clEnqueueReadBuffer(
                self.0, 
                buffer.0, 
                blocking_read_u32,
                offset,
    ...
    fn retain(&self) -> Result {
        unsafe {
            let ret_value = cl::clRetainCommandQueue(self.0);
            return utility::check(ret_value, || {});
        }
    }
    ...
    fn release(&self) -> Result {
        unsafe {
            let ret_value = cl::clReleaseCommandQueue(self.0);
            return utility::check(ret_value, || {});
        }
    }
}
