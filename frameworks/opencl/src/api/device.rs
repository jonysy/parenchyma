...
#[derive(Clone, Debug)]
pub struct DevicePtr(pub(super) opencl_sys::cl_device_id);
...
impl DevicePtr {
    fn info_size(&self, p: u32) -> Result<usize> {
        ...
        unsafe {
            ...
            match opencl_sys::clGetDeviceInfo(self.0, p, 0, ptr::null_mut(), &mut size) {
              ...
              F2: Fn(&mut T) -> *mut c_void
    {
        ...
        unsafe {
            ...
            match opencl_sys::clGetDeviceInfo(self.0, p, size, f2(&mut b), null) {
    ...
    pub fn address_bits(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_ADDRESS_BITS;
    ...
    pub fn available(&self) -> Result<bool> {
        ...
        let p = opencl_sys::CL_DEVICE_AVAILABLE;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn compiler_available(&self) -> Result<bool> {
        ...
        let p = opencl_sys::CL_DEVICE_COMPILER_AVAILABLE;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn endian_little(&self) -> Result<bool> {
        ...
        let p = opencl_sys::CL_DEVICE_ENDIAN_LITTLE;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn error_correction_support(&self) -> Result<bool> {
        ...
        let p = opencl_sys::CL_DEVICE_ERROR_CORRECTION_SUPPORT;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn extensions(&self) -> Result<Vec<String>> {
        ...
        let p = opencl_sys::CL_DEVICE_EXTENSIONS;
    ...
    pub fn global_mem_cache_size(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_GLOBAL_MEM_CACHE_SIZE;
    ...
    pub fn global_mem_cacheline_size(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn global_mem_size(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_GLOBAL_MEM_SIZE;
        let res = self.info(p, |_| 0u64, |b| b as *mut u64 as _)?;
    ...
    pub fn image_support(&self) -> Result<bool> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE_SUPPORT;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn image2d_max_height(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE2D_MAX_HEIGHT;
    ...
    pub fn image2d_max_width(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE2D_MAX_WIDTH;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn image3d_max_depth(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE3D_MAX_DEPTH;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn image3d_max_height(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE3D_MAX_HEIGHT;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn image3d_max_width(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_IMAGE3D_MAX_WIDTH;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn local_mem_size(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_LOCAL_MEM_SIZE;
        let res = self.info(p, |_| 0u64, |b| b as *mut u64 as _)?;
    ...
    pub fn max_clock_frequency(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_CLOCK_FREQUENCY;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_compute_units(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_COMPUTE_UNITS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_constant_args(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_CONSTANT_ARGS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_constant_buffer_size(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE;
        let res = self.info(p, |_| 0u64, |b| b as *mut u64 as _)?;
    ...
    pub fn max_mem_alloc_size(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_MEM_ALLOC_SIZE;
        let res = self.info(p, |_| 0u64, |b| b as *mut u64 as _)?;
    ...
    pub fn max_parameter_size(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_PARAMETER_SIZE;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn max_read_image_args(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_READ_IMAGE_ARGS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_samplers(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_SAMPLERS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_work_group_size(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_WORK_GROUP_SIZE;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn max_work_item_dimensions(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn max_work_item_sizes(&self) -> Result<Vec<usize>> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_WORK_ITEM_SIZES;
    ...
    pub fn max_write_image_args(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MAX_WRITE_IMAGE_ARGS;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn mem_base_addr_align(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MEM_BASE_ADDR_ALIGN;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn min_data_type_align_size(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn name(&self) -> Result<String> {
        ...
        let p = opencl_sys::CL_DEVICE_NAME;
        let res = self.info(p, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
    ...
    pub fn platform(&self) -> Result {
        ...
        let _ = opencl_sys::CL_DEVICE_PLATFORM;
        unimplemented!()
    }
    ...
    pub fn preferred_vector_width_char(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR;
    ...
    pub fn preferred_vector_width_short(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT;
    ...
    pub fn preferred_vector_width_int(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT;
    ...
    pub fn preferred_vector_width_long(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG;
    ...
    pub fn preferred_vector_width_float(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT;
    ...
    pub fn preferred_vector_width_double(&self) -> Result<u32> {
        ...
        let _ = opencl_sys::CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE;
    ...
    pub fn profile(&self) -> Result<String> {
        ...
        let p = opencl_sys::CL_DEVICE_PROFILE;
        let res = self.info(p, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
    ...
    pub fn profiling_timer_resolution(&self) -> Result<usize> {
        ...
        let p = opencl_sys::CL_DEVICE_PROFILING_TIMER_RESOLUTION;
        let res = self.info(p, |_| 0usize, |b| b as *mut usize as _)?;
    ...
    pub fn type_(&self) -> Result<u64> {
        ...
        let p = opencl_sys::CL_DEVICE_TYPE;
        let res = self.info(p, |_| 0u64, |b| b as *mut u64 as _)?;
    ...
    pub fn vendor(&self) -> Result<String> {
        ...
        let p = opencl_sys::CL_DEVICE_VENDOR;
        let res = self.info(p, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
    ...
    pub fn vendor_id(&self) -> Result<u32> {
        ...
        let p = opencl_sys::CL_DEVICE_VENDOR_ID;
        let res = self.info(p, |_| 0u32, |b| b as *mut u32 as _)?;
    ...
    pub fn version(&self) -> Result<String> {
        ...
        let p = opencl_sys::CL_DEVICE_VERSION;
        let res = self.info(p, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
    ...
    pub fn driver_version(&self) -> Result<String> {
        ...
        let p = opencl_sys::CL_DRIVER_VERSION;
        let res = self.info(p, |size| vec![0u8; size], |b| b.as_mut_ptr() as _);
